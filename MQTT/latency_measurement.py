...
def on_message(client, userdata, msg):
    ...
    if msg_count < 10000:
        ...
        client.publish(TOPIC, random_payload) # Publish a message with the random payload
    else:
...
client.publish(TOPIC, random_payload)  # Initial message to start the loop
